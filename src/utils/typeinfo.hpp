...
enum class TypeId : uint64_t {
  ...
  SCAN_PARALLEL,
  SCAN_PARALLEL_BY_ID,
  SCAN_PARALLEL_BY_LABEL,
  SCAN_PARALLEL_BY_LABEL_PROPERTIES,
  SCAN_PARALLEL_BY_POINT_DISTANCE,
  SCAN_PARALLEL_BY_POINT_WITHINBBOX,
  SCAN_PARALLEL_BY_EDGE,
  SCAN_PARALLEL_BY_EDGE_TYPE,
  SCAN_PARALLEL_BY_EDGE_TYPE_PROPERTY,
  SCAN_PARALLEL_BY_EDGE_TYPE_PROPERTY_VALUE,
  SCAN_PARALLEL_BY_EDGE_TYPE_PROPERTY_RANGE,
  SCAN_PARALLEL_BY_EDGE_PROPERTY,
  SCAN_PARALLEL_BY_EDGE_PROPERTY_VALUE,
  SCAN_PARALLEL_BY_EDGE_PROPERTY_RANGE,
  SCAN_PARALLEL_BY_EDGE_ID,
  EXPAND_COMMON,
  SCAN_BY_EDGE_COMMON,
  EXPAND,
  EXPANSION_LAMBDA,
  ...
  REP_SET_PARAMETER_REQ,
  REP_SET_PARAMETER_RES,
  REP_UNSET_PARAMETER_REQ,
  ...
  COORD_GET_ROUTING_TABLE_REQ,
  COORD_GET_ROUTING_TABLE_RES,
  COORD_ADD_COORD_REQ,
  COORD_ADD_COORD_RES,
  COORD_REMOVE_COORD_REQ,
  COORD_REMOVE_COORD_RES,
  COORD_REGISTER_INSTANCE_REQ,
  COORD_REGISTER_INSTANCE_RES,
  COORD_UNREGISTER_INSTANCE_REQ,
  COORD_UNREGISTER_INSTANCE_RES,
  COORD_SET_INSTANCE_TO_MAIN_REQ,
  COORD_SET_INSTANCE_TO_MAIN_RES,
  COORD_DEMOTE_INSTANCE_REQ,
  COORD_DEMOTE_INSTANCE_RES,
  COORD_FORCE_RESET_REQ,
  COORD_FORCE_RESET_RES,
  COORD_UPDATE_CONFIG_REQ,
  COORD_UPDATE_CONFIG_RES,
  COORD_REPL_LAG_REQ,
  COORD_REPL_LAG_RES,
  COORD_UPDATE_DATA_INSTANCE_CONFIG_REQ,
  COORD_UPDATE_DATA_INSTANCE_CONFIG_RES,
  ...
  AST_SHOW_QUERY_CALLABLE_MAPPINGS_QUERY,
  ...
  AST_DROP_ALL_INDEXES_QUERY,
  AST_DROP_ALL_CONSTRAINTS_QUERY,
